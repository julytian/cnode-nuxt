...
<template>
  <div>
    ...
    <section class="login-info">
      <input v-model.trim="token" class="login-input" type="text" placeholder="请输入 Access Token" maxlength="36" />
...
<style lang="scss">
.login-info {
  padding: calc(var(--cnode-padding-base) * 8) calc(var(--cnode-padding-base) * 3);
